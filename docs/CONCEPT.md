...
1. **Unblockable Architecture:** No central servers. Communication happens over a Peer-to-Peer (P2P) network using `libp2p`.
...
- **Economic Disincentives:** Optional small stakes or Proof-of-Work (PoW) for identity registration.
- **Community Moderation:** Decentralized consensus to flag and ignore malicious relay nodes or spammers.
